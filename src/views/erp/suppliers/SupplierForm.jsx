...
const SupplierForm = () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setInitialValues({
          ...
          city: s.city || '',
          address: s.address || '',
          tradeLicenseFilePath: s.trade_license_file_path || '',
          tradeLicenseNumber: s.trade_license_number || '',
          tradeLicenseName: s.trade_license_name || '',
          tradeLicenseExpiryDate: s.trade_license_expiry_date ? String(s.trade_license_expiry_date).slice(0, 10) : '',
          vatCertificateFilePath: s.vat_certificate_file_path || '',
          vatCertificateTrn: s.vat_certificate_trn || '',
          bankDetailsFilePath: s.bank_details_file_path || '',
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      let errorMessage = err.message || 'Failed to save supplier';
      if (err.errors) {
    ...
    <PageContainer title={isEdit ? 'Edit Supplier' : 'Add Supplier'} description="Manage supplier details">
              ...
              <Card elevation={0} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 3, mb: 3 }}>
                <CardContent sx={{ p: { xs: 3, sm: 4, md: 5 } }}>
                  ...
                  <Typography variant="body2" color="text.secondary" mb={4}>
                    Basic supplier details and contact information
                  </Typography>
                  <Divider sx={{ mb: 4 }} />
                    ...
                    <Grid size={12}>
                      <Box position="relative">
                        <Autocomplete
                          ...
                          onBlur={() => setFieldTouched('primaryContactId', true)}
                          renderInput={(params) => (
                            <TextField
                              {...params}
                              label="Contact"
                  ...
                  {linkedContacts.length === 0 ? (
                    ...
                    >
                      ...
                      <Typography variant="body2" mt={1}>
                        Click "Add Contact" to link contacts to this supplier
                      </Typography>
                    </Box>
                  ) : (
      ...
      >
        <DialogTitle sx={{ pb: 2, pt: 4, px: 4 }}>
          <Typography variant="h4" fontWeight={700}>Add Contact to Supplier</Typography>
          <Typography variant="body2" color="text.secondary" mt={1}>
      ...
      >
        <DialogTitle sx={{ pb: 2, pt: 4, px: 4 }}>
          ...
          <Typography variant="body2" color="text.secondary" mt={1}>
            Add a new contact and link to this supplier
          </Typography>
        </DialogTitle>
        <DialogContent sx={{ pt: 5, px: 4 }}>
