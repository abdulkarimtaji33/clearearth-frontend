...
/* ****ERP Pages***** */
const ErpDashboard = Loadable(lazy(() => import('../views/erp/dashboard/Dashboard')));
const ClientList = Loadable(lazy(() => import('../views/erp/clients/ClientList')));
...
const ServiceList = Loadable(lazy(() => import('../views/erp/services/ServiceList')));
const ServiceForm = Loadable(lazy(() => import('../views/erp/services/ServiceForm')));
const JobList = Loadable(lazy(() => import('../views/erp/jobs/JobList')));
const JobForm = Loadable(lazy(() => import('../views/erp/jobs/JobForm')));
const InventoryList = Loadable(lazy(() => import('../views/erp/inventory/InventoryList')));
const ErpInvoiceList = Loadable(lazy(() => import('../views/erp/invoices/InvoiceList')));
const ErpInvoiceForm = Loadable(lazy(() => import('../views/erp/invoices/InvoiceForm')));
const PaymentList = Loadable(lazy(() => import('../views/erp/payments/PaymentList')));
const EmployeeList = Loadable(lazy(() => import('../views/erp/employees/EmployeeList')));
const VehicleList = Loadable(lazy(() => import('../views/erp/vehicles/VehicleList')));
const WarehouseList = Loadable(lazy(() => import('../views/erp/warehouses/WarehouseList')));
const WarehouseForm = Loadable(lazy(() => import('../views/erp/warehouses/WarehouseForm')));
const DocumentList = Loadable(lazy(() => import('../views/erp/documents/DocumentList')));
const CertificateList = Loadable(lazy(() => import('../views/erp/certificates/CertificateList')));
const ReportList = Loadable(lazy(() => import('../views/erp/reports/ReportList')));
const Settings = Loadable(lazy(() => import('../views/erp/settings/Settings')));
const InboundList = Loadable(lazy(() => import('../views/erp/inbound/InboundList')));
const OutboundList = Loadable(lazy(() => import('../views/erp/outbound/OutboundList')));
const CommissionList = Loadable(lazy(() => import('../views/erp/commissions/CommissionList')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/erp/clients', element: <ClientList /> },
      { path: '/erp/clients/create', element: <ClientForm /> },
      { path: '/erp/clients/edit/:id', element: <ClientForm /> },
      ...
      { path: '/erp/services', element: <ServiceList /> },
      { path: '/erp/services/create', element: <ServiceForm /> },
      { path: '/erp/services/edit/:id', element: <ServiceForm /> },
      { path: '/erp/jobs', element: <JobList /> },
      { path: '/erp/jobs/create', element: <JobForm /> },
      { path: '/erp/jobs/edit/:id', element: <JobForm /> },
      { path: '/erp/inventory', element: <InventoryList /> },
      { path: '/erp/inventory/lots', element: <InventoryList /> },
      { path: '/erp/invoices', element: <ErpInvoiceList /> },
      { path: '/erp/invoices/create', element: <ErpInvoiceForm /> },
      { path: '/erp/invoices/edit/:id', element: <ErpInvoiceForm /> },
      { path: '/erp/payments', element: <PaymentList /> },
      { path: '/erp/employees', element: <EmployeeList /> },
      { path: '/erp/vehicles', element: <VehicleList /> },
      { path: '/erp/warehouses', element: <WarehouseList /> },
      { path: '/erp/warehouses/create', element: <WarehouseForm /> },
      { path: '/erp/warehouses/edit/:id', element: <WarehouseForm /> },
      { path: '/erp/documents', element: <DocumentList /> },
      { path: '/erp/certificates', element: <CertificateList /> },
      { path: '/erp/inbound', element: <InboundList /> },
      { path: '/erp/outbound', element: <OutboundList /> },
      { path: '/erp/commissions', element: <CommissionList /> },
      { path: '/erp/reports', element: <ReportList /> },
      { path: '/erp/settings', element: <Settings /> },
