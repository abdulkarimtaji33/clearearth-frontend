...
const VendorPurchaseQuotationList = () => {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      setLoading(true);
      const params = { page: page + 1, pageSize: rowsPerPage, search, statusNot: 'approved', side: 'supplier' };
  ...
  return (
    <PageContainer title="Vendor purchase quotations" description="Draft and pending quotations to vendors; approve to move to Vendor Purchase Orders">
      <Box>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={3} flexWrap="wrap" gap={2}>
          <Box>
            <Stack direction="row" alignItems="center" spacing={1.5} mb={0.5}>
              ...
              <Typography variant="h4" fontWeight={700}>Vendor purchase quotations</Typography>
            </Stack>
                ...
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={7} align="center" sx={{ py: 8 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">No vendor purchase quotations found</Typography>
                    </TableCell>
                  </TableRow>
                ) : (
                  orders.map(o => (
...
export default VendorPurchaseQuotationList;
